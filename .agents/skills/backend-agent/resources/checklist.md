...
## Database
- [ ] Migrations created (Alembic / Prisma Migrate / golang-migrate — whichever fits the stack) and tested
...
- [ ] Input validated with schema library (Pydantic / Zod / go-playground/validator — whichever fits the stack)
